...
import { HomeIcon, Cog6ToothIcon, UserCircleIcon, BriefcaseIcon } from '@heroicons/react/24/outline';
import { HomeIcon as HomeIconSolid, Cog6ToothIcon as Cog6ToothIconSolid, UserCircleIcon as UserCircleIconSolid, BriefcaseIcon as BriefcaseIconSolid } from '@heroicons/react/24/solid';
                ...
                <div className="flex items-center justify-around py-2">
                    {navItems.map(({ path, label, Icon, IconActive }) => {
                        const isActive = location.pathname === path ||
                            (path === '/scout' && location.pathname.startsWith('/scout'));
